...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        host21 = self.addHost( 'h21',mac='01:00:00:00:00:21',ip='10.0.0.5/8' )
        host22 = self.addHost( 'h22',mac='01:00:00:00:00:22',ip='10.0.0.6/8' )
        host23 = self.addHost( 'h23',mac='01:00:00:00:00:23',ip='10.0.0.7/8' )
        host24 = self.addHost( 'h24',mac='01:00:00:00:00:24',ip='10.0.0.8/8' )
        
        host31 = self.addHost( 'h31',mac='01:00:00:00:00:31',ip='10.0.0.9/8' )
        host32 = self.addHost( 'h32',mac='01:00:00:00:00:32',ip='10.0.0.10/8' )
        host33 = self.addHost( 'h33',mac='01:00:00:00:00:33',ip='10.0.0.11/8' )
        host34 = self.addHost( 'h34',mac='01:00:00:00:00:34',ip='10.0.0.12/8' )
    
        host41 = self.addHost( 'h41',mac='01:00:00:00:00:41',ip='10.0.0.13/8' )
        host42 = self.addHost( 'h42',mac='01:00:00:00:00:42',ip='10.0.0.14/8' )
        host43 = self.addHost( 'h43',mac='01:00:00:00:00:43',ip='10.0.0.15/8' )
        host44 = self.addHost( 'h44',mac='01:00:00:00:00:44',ip='10.0.0.16/8' )
