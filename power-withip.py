...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        host31 = self.addHost( 'h31',mac='00:00:00:00:00:31',ip='10.3.0.1/8' )
        host32 = self.addHost( 'h32',mac='00:00:00:00:00:32',ip='10.3.0.2/8' )
        host33 = self.addHost( 'h33',mac='00:00:00:00:00:33',ip='10.3.0.3/8' )
        host34 = self.addHost( 'h34',mac='00:00:00:00:00:34',ip='10.3.0.4/8' )
        
        host41 = self.addHost( 'h41',mac='00:00:00:00:00:41',ip='10.4.0.1/8' )
        host42 = self.addHost( 'h42',mac='00:00:00:00:00:42',ip='10.4.0.2/8' )
        host43 = self.addHost( 'h43',mac='00:00:00:00:00:43',ip='10.4.0.3/8' )
        host44 = self.addHost( 'h44',mac='00:00:00:00:00:44',ip='10.4.0.4/8' )
        ## Switches
